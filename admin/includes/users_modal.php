    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><b>Tambah Pelanggan Baru</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="users_add.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="lastname" class="col-sm-3 control-label">Nama Terakhir</label>
                ...
                <div class="form-group">
                    <label for="contact" class="col-sm-3 control-label">No.Handphone</label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="users_edit.php">
                ...
                <div class="form-group">
                    <label for="edit_contact" class="col-sm-3 control-label">No.Handphone</label>
