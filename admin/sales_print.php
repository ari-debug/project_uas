<?php
	...
	function generateRow($from, $to, $conn){
		...
		$contents .= '
			<tr>
				...
				<td align="right"><b>R p'.number_format($total, 2).'</b></td>
			</tr>
		';
		return $contents;
	}
	...
	if(isset($_POST['print'])){
	    ...
	    $content = '';  
	    $content .= '
	      	<h2 align="center">Music Creative Production</h2>
	      	<h4 align="center">Laporan Penjualan Toko Musik 5G</h4>
	      	<h4 align="center">'.$from_title." - ".$to_title.'</h4>
	      	<table border="1" cellspacing="0" cellpadding="3">  
	           <tr>  
	           		<th width="15%" align="center"><b>Tanggal</b></th>
	                <th width="30%" align="center"><b>Nama Pembeli</b></th>
					<th width="40%" align="center"><b>Transaksi#</b></th>
